...
import com.kodlab.kimnerede.adapter.KimlerListAdapter;
import com.kodlab.kimnerede.db.DatabaseManager;
...
public class ArkadasEkleAsyncTask extends AsyncTask<String, String, List<Profil>> {
	...
	protected void onPostExecute(List<Profil> result) {
		...
		KimlerListAdapter adapter = new KimlerListAdapter(context, R.layout.kimler_list_item, result);

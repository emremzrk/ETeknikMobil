...
public class NetworkManager {
	...
	public static String profilKaydet(Profil profil) {
		...
		try {
			...
			HttpPost request = new HttpPost(BaseActivity.KIM_NEREDE_PROFIL_KAYDET_URL);
	...
	public static List<Profil> arkadasSorgula(String kullaniciAdi) {
		...
		try {
			...
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost(BaseActivity.KIM_NEREDE_ARKADAS_LISTELE_URL);
	...
	public static String arkadasEkle(String kullaniciAdi, String arkadasKullaniciAdi) {
		...
		try {
			...
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost(BaseActivity.KIM_NEREDE_ARKADAS_EKLE_URL);
	...
	public static String konumKaydet(Konum konum) {
		...
		try {
			...
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost(BaseActivity.KIM_NEREDE_KONUM_KAYDET_URL);
	...
	public static List<Konum> konumSorgula(String kullaniciAdi) {
		...
		try {
			...
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost(BaseActivity.KIM_NEREDE_KONUM_SORGULA_URL);
